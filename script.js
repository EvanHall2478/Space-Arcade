...
async function login() {
	...
	try {
		...
		const redShipSkinPurchased = await getSkinsPurchased(username);
		console.log(redShipSkinPurchased); 
		localStorage.setItem('redShipSkinPurchased', redShipSkinPurchased); 
		/*const blueShipSkinPurchased = await getSkinsPurchased(username, blueShipSkinPurchased);
		localStorage.setItem('blueShipSkinPurchased', blueShipSkinPurchased);
		const yellowShipSkinPurchased = await getSkinsPurchased(username, yellowShipSkinPurchased);
		localStorage.setItem('yellowShipSkinPurchased', yellowShipSkinPurchased);
		const redAsteroidSkinPurchased = await getSkinsPurchased(username, redAsteroidSkinPurchased);
		localStorage.setItem('redAsteroidSkinPurchased', redAsteroidSkinPurchased);
		const blueAsteroidSkinPurchased = await getSkinsPurchased(username, blueAsteroidSkinPurchased);
		localStorage.setItem('blueAsteroidSkinPurchased', blueAsteroidSkinPurchased);
		const yellowAsteroidSkinPurchased = await getSkinsPurchased(username, yellowAsteroidSkinPurchased);
		localStorage.setItem('yellowAsteroidSkinPurchased', yellowAsteroidSkinPurchased); */ 
		location.href = '/~/projects/Space_Arcade/Game_Menu' //timer? 
...
async function getSkinsPurchased(username) {
	try {
		...
		const ans = await resp.json();
		console.log(ans); 
		return ans.find(item => item.data.username === username).data.redShipSkinPurchased //THIS IS THE ERROR 
	} catch (ex) {
		alert("error");
	}
}
